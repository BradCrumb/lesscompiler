 ...
 */
    public $settings = array(
        'sourceFolder' => false /* From the APP directory */
    ,   'targetFolder' => false /* From the webroot directory */
    ,   'formatter' => 'compressed'
    ,   'preserveComments' => null /* true or false, default is false */
    ,   'variables' => array()
            ...
            foreach ($this->_lessFolders as $key => $lessFolder) {
                foreach ($lessFolder->find() as $file) {
                    ...
                    if ($file->ext() == 'less' && substr($file->name, 0, 2) !== '._') {
                        ...
                        if ($this->__autoCompileLess($lessFile, $cssFile, $lessFolder->path . DS)) {
 ...
 * @return boolean
 */
    protected function __autoCompileLess($inputFile, $outputFile, $lessFolder) {
